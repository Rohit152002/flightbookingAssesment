    ...
    <div class="max-w-xl mx-auto bg-white rounded-xl shadow-sm p-8">
      ...
      <form @submit.prevent="submitPayment" class="space-y-6">
        ...
        <div class="space-y-1">
          ...
          />
          <p v-if="errors.ccNumber" class="text-sm text-red-500 mt-1">
            {{ errors.ccNumber }}
          </p>
        </div>
        ...
        <div class="grid grid-cols-2 gap-4">
          ...
          <div class="space-y-1">
            ...
            />
            <p v-if="errors.cvv" class="text-sm text-red-500 mt-1">
              {{ errors.cvv }}
            </p>
          </div>
          ...
          <div class="space-y-1">
            ...
            />
            <p v-if="errors.expiryDate" class="text-sm text-red-500 mt-1">
              {{ errors.expiryDate }}
            </p>
          </div>
        </div>
        ...
        <div class="flex gap-4 pt-4">
          ...
          <button
            type="button"
            @click="goBack"
            class="flex-1 bg-gray-100 text-gray-700 py-3 px-6 rounded-lg font-medium hover:bg-gray-200 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2"
          >
            Back
          </button>
        </div>
